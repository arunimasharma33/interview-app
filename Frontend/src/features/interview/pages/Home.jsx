...
const Home = () => {
  ...
  title: "",
    ...
    const handleGenerateReport = async () => {
        ...
        const data = await generateReport({ jobDescription, selfDescription, resumeFile, title: formData.title })
        ...
        <div className='home-page'>
            ...
            <div className='interview-card'>
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--job-title'>
  ...
  <input
    id='jobTitle'
    type="text"
    className='panel__textarea job-title-input'
